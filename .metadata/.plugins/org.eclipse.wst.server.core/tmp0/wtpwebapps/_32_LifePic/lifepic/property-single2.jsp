    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single"> Dobai Sky</h1>
          <span class="color-text-a">UAE | Annabela</span>
        </div>
      </div>
      ...
      <!-- <div id="property-single-carousel" class="swiper">
        <div class="swiper-wrapper">
          ...
          <div class="img-wrapper">
              <img src="images/1491580968138.jpeg" float: left; max-width:100%  width="736px" height="490px" alt="">
          </div>
       
        
        
                  <!-- aaaaa수정aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
        ...
        <div class="row">
          ...
          <form style="margin-right: 180px;">
              ...
              <button type="submit" class="btn1" >BUY DIGITAL DOWNLOAD</button>
  ...
  <!-- <div class="row">
    ...
    <div class="col-md-10 offset-md-1">
      ...
      <section class="property-single nav-arrow-b">
        ...
        <div class="swiper-wrapper">
          <div class="carousel-item-b swiper-slide">
            <img src="images/karim-manjra-vZq9_GBUOVI-unsplash.jpg" float: left; width="100%" height="100%" alt="">
          </div>
          <div class="carousel-item-b swiper-slide">
            <img src="images/1491580968138.jpeg" float: left; width="100%" height="100%" alt="">
        </div>
      </div>
    </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="row section-t3">
        <div class="col-sm-12">
          <div class="title-box-d">
            <h3 class="title-d">Photographer</h3>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <img src="<%=request.getContextPath()%>/assets/img/agent-4.jpg" alt="" class="img-fluid">
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="property-agent">
            ...
            <p class="color-text-a">
              AWARDS:	Starred
<br>Interview with Adam Batterbee
<br>A Celebration: Love in the Picfair Collection
<br>Best of 2013: Images of the future
            </p>
