        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item " href="blog-single.jsp">Commet</a>
              <a class="active dropdown-item " href="agents-grid.jsp">Photographer</a>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Our Amazing photographer</h1>
              <span class="color-text-a">Grid photo</span>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
              ...
              <div class="card-overlay card-overlay-hover">
                ...
                <div class="card-body-d">
                  ...
                  <div class="info-agents color-a">
                    ...
                    <p>
                      <strong>Email: </strong> qkrwlsgud890@gmail.com
                    </p>
                  </div>
                </div>
            ...
            <div class="card-box-d">
              ...
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="#" class="link-two">WonJun Heo
                        <br> wonjun</a>
                    </h3>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="<%=request.getContextPath()%>/assets/img/agent-3.jpg" alt="" class="profile">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="<%=request.getContextPath()%>/assets/img/agent-1.jpg" alt="" class="profile">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="<%=request.getContextPath()%>/assets/img/agent-6.jpg" alt="" class="profile">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
